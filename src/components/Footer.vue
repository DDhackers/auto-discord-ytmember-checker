<template>
  <div
    class="w-full shadow-lg h-14 flex justify-space-between items-center bg-neutral-800 px-4 bottom-0"
  >
    <div class="left-side">
      <div>
        <span class="text-sm">
      ...
      <div>
        ...
        >
          <svg
            ...
            height="24"
            fill="currentColor"
            class="text-indigo-300 mr-3 text-opacity-50 transform inline"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
